...
export default class AddFamily extends Component{
    ...
    handleSubmit(e){
        ...
        if ( this.state.error_hp && this.state.error_ktp && this.state.error_pos ) {
            axios.post(API_URL + 'farmers/families', {
                farmer_id: this.props.farmerId,
                name: document.getElementById('name').value,
                relationship_status: document.getElementById('rel_status').value,
                ...
                birthdate: this.state.datepicker,
                ...
                <div className="popup-container">
                    <div className="box-content">
                        <div className="content">
                            <p className="title">Tambah Anggota Keluarga</p>
                            <p className="sub-title">Silakan masukkan data anggota keluarga dengan benar.</p>
                            {   this.state.error ? 
                            ...
                            <div className="box-btn auto" onClick={this.props.togglePopupAddFamily}>
                                <ButtonPrimary
